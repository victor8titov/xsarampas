...
<header class="header">
   ...
   <div class="header__right-side">
      ...
      <a href="<?php echo get_site_url();?>/feedback" class="xsa-button">Закажи скейт-парк сейчас</a>
   </div>
   
   <!-- header menu -->
   <div class="menu-oneline">
   <ul>
      ...
      <li><a href="<?php echo get_site_url();?>/media">ВИДЕО</a></li>
