...
<div class="wrap">
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			<h1 class="entry-title font5">Статьи</h1>
			...
			$args = array( 'post_parent' => 1828 , 'post_type' => 'page', 'posts_per_page' => 10, 'paged' => $page );
			...
			while ( have_posts() ) : the_post();
				...
				<div class="row"> 
					...
					<?php } else {?>
						<a href="<?php the_permalink(); ?>"><img src="/wp-content/themes/xsarampas/assets/images/no_image_available.png" alt="no-photo" width="300" /></a>
					<?}?>
					</div>
