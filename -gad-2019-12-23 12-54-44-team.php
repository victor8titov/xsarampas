		...
		<main id="main" class="site-main" role="main">
			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
					...
					<div class="team-item"><a href="/about/vitek"><img src="/wp-content/themes/xsarampas/assets/images/team/vitek.jpg" alt="" width="134" height="134" /></a><span class="font_10">ВИТЕК</span></div>
				</div>
