		...
		<main id="main" class="site-main" role="main">
			...
			<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
				...
				?>
					...
					<div class="row">
						<h2 class="entry-title font5">
							<a href="http://www.xsaramps.com/news/<?php echo $post->post_name; ?>">
								<?php the_title(); ?>
							</a>
						</h2>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
							...
							<?php else : ?>
								<a href="http://www.xsaramps.com/news/<?php echo $post->post_name; ?>">
									<img src="/wp-content/themes/xsarampas/assets/images/no_image_available.png" alt="no-photo" width="300" />
								</a>
							<?php endif; ?>
