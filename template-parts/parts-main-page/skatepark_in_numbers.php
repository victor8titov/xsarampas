...
<div class="skatepark-in-numbers">
	...
	<div class="skatepark-in-numbers__row-2">
		<div class="skatepark-in-numbers__row-2-col-1">
			...
			<?php if ($skatepark_in_numbers->check_field('field-4-title')) : ?>
		...
		<div>
			...
			<?php if ($skatepark_in_numbers->check_field('field-5-title')) : ?>
				<span class="skatepark-in-numbers__number"><?php $skatepark_in_numbers->put_text('field-5-title'); ?></span>
			<?php endif; ?>
		...
		<div>
			...
			<?php if ($skatepark_in_numbers->check_field('field-8-title')) : ?>
